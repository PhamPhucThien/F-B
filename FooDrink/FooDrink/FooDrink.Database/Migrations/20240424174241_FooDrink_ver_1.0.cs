...
{
    public partial class FooDrink_ver_10 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            _ = migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalRevenue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DailyRevenue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MonthlyRevenue = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            _ = migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FavoritedList = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            _ = migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalePrice = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            _ = migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryList = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageList = table.Column<string>(type: "nvarchar(max)", nullable: false),
